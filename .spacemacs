...
(defun dotspacemacs/user-config ()
  ...
  (defun my-org-daily-agenda () (interactive) (org-agenda nil "d"))
  (defun my-org-add-todo () (interactive) (org-capture nil "t"))
  ...
  (defvar org-my-general-files "~/Dropbox/org")
  (defvar org-my-inbox-file "~/Dropbox/org/inbox.org")
  (defvar org-my-mobile-inbox-file "~/Dropbox/org/inbox_mobile.org")
  ...
  (global-set-key (kbd "C-c y") (lambda() (interactive) (insert "λ")))
